...
RUN apt-get install -y curl grep sed dpkg tmux && \
...
RUN conda create -n torch14 python=3.6 pytorch torchvision cudatoolkit=10.1 tqdm openblas-devel pysoundfile torchaudio cython -c pytorch -c anaconda -c conda-forge
